export const zhTW = {
   ...
   database: {
      ...
      fieldName: '欄位名',
      editField: '編輯欄位',
      commentPlaceholder: '輸入描述...',
      translateWithAi: 'AI 自動翻譯',
      aiKeyRequired: '請在設定中填入 AI API Key 以使用翻譯功能',
      engine: '引擎',
      field: '字段 | 字段',
      approximately: '大約',
      total: '總計',
      ...
      searchForElements: '搜尋表名稱/描述',
      searchForSchemas: '搜尋資料庫名稱',
      searchForColumns: '搜尋欄位名稱/描述',
      savedQueries: '已保存的查詢',
      tableChecks: '資料表檢查',
