...
export const enUS = {
   ...
   database: { // Database related terms
      ...
      translateWithAi: 'Auto-translate with AI',
      aiKeyRequired: 'Set AI API key in Settings to use translation',
      engine: 'Engine',
      field: 'Field | Fields',
      ...
      searchForElements: 'Search tables/comments',
      searchForSchemas: 'Search database names',
      searchForColumns: 'Search columns/comments',
